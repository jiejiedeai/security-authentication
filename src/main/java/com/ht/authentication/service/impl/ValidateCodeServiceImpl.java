...
import com.ht.authentication.service.ValidateCodeService;
import com.ht.authentication.util.WYCloudUtil;
...
public class ValidateCodeServiceImpl implements ValidateCodeService {
    ...
    @Override
    public SmsCode createSmsCode(String mobile) {
        JSONObject jsonObject = WYCloudUtil.sendCodeNote(mobile);
